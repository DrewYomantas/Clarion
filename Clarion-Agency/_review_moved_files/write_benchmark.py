"""
write_benchmark.py  --  one-shot file writer for benchmark_engine.py
Run from repo root: python write_benchmark.py
"""
import pathlib

TARGET = pathlib.Path(
    r"C:\Users\beyon\OneDrive\Desktop\CLARION\law-firm-insights-main"
    r"\backend\services\benchmark_engine.py"
)

CONTENT = r'''# FILE: backend/services/benchmark_engine.py
"""
