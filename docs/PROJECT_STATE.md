...
- The current blocker is no longer whether to keep the Wave80 rows in the gate; it is how to design the next narrow calibration pass against their staged miss clusters.
...
### Current Next Pass
5. Honest next move:
   - latest completed milestone is Pass 45 (`2026-04-08`)
   ...
   - current live acquisition status:
     ...
     - next useful step is a focused miss-cluster audit / calibration-design pass on the staged `7` rows before any engine work
